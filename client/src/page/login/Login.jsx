...
.catch(err=>{console.log(err)
  ...
  return (
    <div>
      {" "}
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-orange-500 text-white mx-auto my-8">
        <Toaster />
        ...
        >
          ...
          <button className="  w-full p-3 text-center rounded-sm bg-gradient-to-r from-blue-400 to-orange-600  text-white mx-2">
            LOGIN
          </button>
        </form>
        <div className="flex items-center pt-4 space-x-1">
          <div className="flex-1 h-px sm:w-16 bg-gray-700"></div>
          <p className="px-3 text-sm text-white-500">
        ...
        <p className="text-xs text-center sm:px-6 text-white-500">
